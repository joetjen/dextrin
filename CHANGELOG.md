...
- GitHub Pages documentation, published from `main` via the existing
  `docs.yml` workflow. Linked from `README.md` and from `mix.exs`'
  package `links` alongside the hexdocs.pm release docs.
